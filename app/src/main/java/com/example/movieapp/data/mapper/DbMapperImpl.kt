...
class DbMapperImpl : DbMapper, KoinComponent {
    ...
    override fun mapDbMovieDetailsToMovieDetails(movieDetails: DbMovieDetails) = MovieDetails(
        ...
        originalLanguage = movieDetails.originalLanguage,
        originalTitle = movieDetails.originalTitle,
        genres = mapDbGenresToGenres(movieDb.movieGenreJoinDao().getGenresForMovie(movieDetails.id).blockingGet()),
        countries = mapDbProductionCountriesToProductionCountries(movieDb.movieCountryJoinDao().getCountriesForMovie(movieDetails.id).blockingGet()),
        isAdult = movieDetails.isAdult,
        overview = movieDetails.overview,
        releaseDate = movieDetails.releaseDate,
        runtime = movieDetails.runtime,
