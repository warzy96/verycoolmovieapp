...
class GetMovieDetailsUseCase : SingleUseCase<MovieDetailsViewModel, Int>, KoinComponent{

    private val repository: MovieRepository by inject()
    private val viewModelMapper: ViewModelMapper by inject()

    override fun execute(movieId: Int): Single<MovieDetailsViewModel> = repository.getMovie(movieId)
